...
/**
 * Calendar subscription updated class.
 *
 * @package    core
 * @copyright  2014 Shubhangee Verma <shubhv92@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class calendar_subscription_updated extends base {
    ...
    public function get_description() {
        return "User {$this->userid} has updated a calendar subscription with id {$this->objectid}.";
    }
    ...
    public function get_url() {
        return new \moodle_url('calendar/managesubscriptions.php', array('id' => $this->objectid));
    }
